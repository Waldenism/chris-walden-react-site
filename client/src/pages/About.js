            ...
            <article className="tile is-child notification walden centroid">
              <div className="">
                ...
                <div className="content">
                  ...
                  <p>
                    Flexes advanced computer literacy for professional excel, word, web documents. Avid learner with high energy and a great attitude. Desires to solve problems and improve upon existing methods. Approaches challenges from different angles, and yearns for collaboration with others to facilitate effective communication and service for Nike members. 
                  </p>
        ...
        <div className="tile is-vertical">
          ...
          <div className='tile is-parent'>
            <article className='tile is-child notification is-dark'>
              ...
              <p className="subtitle"> </p>
              <div className='content'>
                <p>As a true consumerists obessesed with serving the Nike member with the same exemplarly treatment we give our Elite athletes, every interaction needs to be approached as if the member is meeting Nike for the first time.</p>
